  ...
  return (
    <>
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50" onClick={onClose}>
        <div 
          className={`${colors[note.color] || 'bg-white'} rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col`}
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header */}
          <div className="border-b border-gray-200 p-6 flex items-start justify-between">
            <div className="flex-1 min-w-0 pr-4">
              <h2 className="text-3xl font-bold text-gray-900 mb-2 break-words">
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {note.tags.map(tag => (
                    <span 
                      key={tag}
                      className="inline-flex items-center space-x-1.5 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium"
                    >
          ...
          {/* Footer Actions */}
          <div className="border-t border-gray-200 p-4 flex flex-wrap items-center justify-between gap-3 bg-gray-50">
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span className="text-sm font-medium">{note.isPinned ? 'Unpin' : 'Pin'}</span>
              </button>
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-white text-gray-700 hover:bg-gray-100 border border-gray-300 rounded-lg transition-colors"
                title="Duplicate"
              >
